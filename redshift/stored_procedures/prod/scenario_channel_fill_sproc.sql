CREATE OR REPLACE PROCEDURE prod.scenario_channel_fill_sproc(group_param varchar)
    LANGUAGE plpgsql
AS $$
...
CREATE TABLE IF NOT EXISTS stage.scenario_channel_fill_landing(
...
EXECUTE 'GRANT ALL ON TABLE stage.scenario_channel_fill_landing TO GROUP '||group_param||';';
