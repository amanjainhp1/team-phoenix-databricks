CREATE OR REPLACE PROCEDURE prod.scenario_mix_rate_sproc(group_param varchar)
    LANGUAGE plpgsql
AS $$
...
CALL prod.addversion_sproc('SCENARIO_MIX_RATE', 'FORECASTER INPUT');
...
EXECUTE 'GRANT ALL ON TABLE stage.scenario_mix_rate_staging TO GROUP '||group_param||';';
