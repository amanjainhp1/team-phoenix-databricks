--Source: https://github.com/awslabs/amazon-redshift-utils/blob/e4edbfdbafa3e6adad1d6aabef42d0408fd7999f/src/AdminViews/v_generate_tbl_ddl.sql
--DROP VIEW prod.generate_tbl_ddl_vw;
/**********************************************************************************************
...
**********************************************************************************************/
CREATE OR REPLACE VIEW prod.generate_tbl_ddl_vw
AS
SELECT
 table_id
