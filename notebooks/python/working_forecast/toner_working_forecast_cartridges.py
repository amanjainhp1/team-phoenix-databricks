...
# MAGIC %md
# MAGIC ## sub-routine 5 :: select correct page mix override records, blow out to market10 for region_5 records
   ...
   , override_filters      AS
    (SELECT DISTINCT 'SCENARIO_MIX_RATE'                AS record
     ...
     WHERE 1 = 1
       ...
       AND UPPER(smr.user_name) IN ('JON.LINDBERG@HP.COM','GRETCHENB', 'GRETCHEN.BRUNNER@HP.COM', 'VANB', 'WILLIAM.VAN.BAIN@HP.COM', 'YONGHOONL', 'YONGHOON.LEE@HP.COM'))
...
# MAGIC %md
# MAGIC ## sub-routine 7: run page_cartridges process with new input dataset
...
FROM scen.toner_07_page_cc_cartridges ccs
