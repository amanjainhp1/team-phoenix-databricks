...
# MAGIC from baseprod_add_planet_adjusts
# MAGIC where 1=1 
# MAGIC and pl in (select pl from mdm.product_line_xref where pl_category = 'SUP' and technology in ('INK', 'LASER', 'PWA'))
# MAGIC --and platform_subset = 'NA'
# MAGIC --and base_product_number NOT LIKE 'UNK%'
# MAGIC --and base_product_number NOT LIKE 'EDW%'
