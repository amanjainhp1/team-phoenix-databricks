...
configs["redshift_url"] = constants[role]["REDSHIFT_URL"][stack]
configs["redshift_port"] = constants[role]["REDSHIFT_PORT"][stack]
configs["redshift_dev_group"] = constants[role]["REDSHIFT_DEV_GROUP"][stack]
configs["redshift_dbname"] = constants[role]["REDSHIFT_DATABASE"][stack]
configs["redshift_temp_bucket"] = constants[role]["S3_BASE_BUCKET"][stack] + "redshift_temp/"
configs["aws_iam_role"] = constants[role]["REDSHIFT_IAM_ROLE"][stack]
...
if sql_server_access:
    ...
    configs["sfai_url"] = constants[role]["SFAI_URL"]
    configs["sfai_driver"] = constants[role]["SFAI_DRIVER"]
