...
tables = ['fin_stage.forecast_base_pl' , 'prod.currency_hedge' ,  'mdm.iso_country_code_xref' , 'mdm.country_currency_map' , 'stage.supplies_stf_landing' , 'mdm.product_line_scenarios_xref' , 'mdm.calendar' , 'fin_prod.forecast_fixed_cost_input'  , 'prod.working_forecast_country' , 'mdm.rdma' , 'mdm.supplies_xref' , 'fin_prod.actuals_supplies_baseprod' , 'mdm.product_line_xref' , 'prod.version']
