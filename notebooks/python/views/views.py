  ...
  WITH current_fiscal_yr AS (
    ...
    supplies_baseprod_actuals AS (
        ...
        FROM fin_prod.actuals_supplies_baseprod actuals_supplies_baseprod
            ...
            left join mdm.product_line_xref product_line_xref on product_line_xref.pl = actuals_supplies_baseprod.pl
...
,
    ...
    (
        ...
        FROM fin_prod.forecast_supplies_baseprod forecast_supplies_baseprod
            ...
            left join mdm.product_line_xref product_line_xref on product_line_xref.pl = forecast_supplies_baseprod.base_product_line_code 
            CROSS JOIN current_fiscal_yr
        WHERE fiscal_yr <= end_fiscal_yr
            and day_of_month = 1
...
GRANT ALL ON TABLE financials.act_plus_fcst_financials_vw TO GROUP phoenix_dev;
"""
