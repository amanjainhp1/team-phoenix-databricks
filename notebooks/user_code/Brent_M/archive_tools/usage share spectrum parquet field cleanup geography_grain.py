...
# load parquet file
usage_share_spectrum = spark.read.parquet("s3://dataos-core-prod-team-phoenix/spectrum/usage_share/2022.10.27.1/")
...
newDf = usage_share_spectrum.withColumn('geography_grain', regexp_replace('geography_grain', 'MARKET 10', 'MARKET10'))
