...
# NEED TO CHANGE THE STACK SO I CAN WRITE TO THE -FIN BUCKET
...
s3_usage_share_output_bucket = constants["S3_BASE_BUCKET"][stack] + "landing/EDW/edw_revenue_document_currency_landing/"
...
s3_usage_share_output_bucket = constants["S3_BASE_BUCKET"][stack] + "landing/EDW/edw_revenue_dollars_landing/"
...
s3_usage_share_output_bucket = constants["S3_BASE_BUCKET"][stack] + "landing/EDW/edw_revenue_units_base_landing/"
...
s3_usage_share_output_bucket = constants["S3_BASE_BUCKET"][stack] + "landing/EDW/edw_shipment_actuals_landing/"
