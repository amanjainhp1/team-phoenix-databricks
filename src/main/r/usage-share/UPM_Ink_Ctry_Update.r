...
# MAGIC title: "UPM ink at country level"  
...
# read in input data
zero <- read.df("dbfs:/mnt/usage-share/ink/input/zero.csv", source = "com.databricks.spark.csv", header="true", inferSchema = "true")
...
#               , hw.intro_price as product_intro_price, id.intro_date as product_introduction_date
